...
test('M5 C2: broken symlink at per-session handoff path is silently skipped', async () => {
  const root = mktemp();
...
test('M5 C2 (I9 expansion): symlinked SUBDIR pointing outside is rejected (Round 3 polish)', async () => {
