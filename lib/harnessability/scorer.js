...
// that project, save the report to <projectRoot>/.deep-dashboard/harnessability-report.json,
// and emit the result as JSON on stdout. If no argument is given, uses cwd.
