...
//   - `ndjson`:   producer-emitted append-only event log (4 sources: 3 hook
//                 logs + deep-wiki vault `log.jsonl`).
//
...
export const EXPECTED_SOURCES = Object.freeze([
  ...
  // NDJSON event logs (4) — hook activity + deep-wiki vault event stream
